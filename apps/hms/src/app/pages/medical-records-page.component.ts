...
@Component({
  ...
  template: `
    <div class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden p-8">
      <h2 class="text-2xl font-black text-slate-800 dark:text-white mb-6">Medical Records</h2>
      <p class="text-slate-500 dark:text-slate-400">Patient medical records will be displayed here.</p>
    </div>
  `,
